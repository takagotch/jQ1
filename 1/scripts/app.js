...
AppModle.prototype.set = function(val){
...
AppModel.prototype.validate = function(){
  ...
  for(var key in this.attrs){
    val = this.attrs[keys];
    if(val && !this.attrs[key](val)) this.errors.push(key);
  }
...
AppView.prtotype.initialize = function(el){
  this.$el = $(el);
...
AppView.prototype.handleEvnets = function(){
  var self = this;
